...
int main(void)
{
	...
	int n=sizeof(tab3)/sizeof(int);

	_Bool (*f_ptr_tri_croissant)(int a,int b)=&asc;
	_Bool (*f_ptr_tri_decroissant)(int a,int b)=&desc;
	bublle_sort_v2(tab3,n,f_ptr_tri_decroissant);
	affiche(tab3,n);
	return 0;
